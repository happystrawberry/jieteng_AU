...
class DNS1D {
    ...
    protected function getBarcodeSVG($code, $type, $w = 2, $h = 30, $color = 'black') {
        ...
        $svg .= '<svg width="' . round(($this->barcode_array['maxw'] * $w), 3) . '" height="' . ($h +15). '" version="1.1" xmlns="http://www.w3.org/2000/svg">' . "\n";
        ...
        $svg .= "\t" . '</g>' . "\n";
        $svg .='<g><text x="50%" y="100%" style="font-size:13px;font-family: sans-serif;" text-anchor="middle">'.$code.'</text></g>'."\n";
        $svg .= '</svg>' . "\n";
        return $svg;
    }
